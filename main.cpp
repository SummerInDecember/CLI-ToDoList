...
int main(int argc, char *argv[]){
    ...
    if(!checkIfItWasRunned){
        ...
        cout << "Do you want to add another goal?:(y/n) ";
        cin >> willAddAnother;

        if(willAddAnother == 'y' || willAddAnother == 'Y'){
            amountieOfGoals++;
            string secondGoal;
        ...
        else if(willAddAnother == 'n' || willAddAnother == 'N'){
            cout << "OK\n";
        }
        else {
            cout << "That is not a valid option\n";
